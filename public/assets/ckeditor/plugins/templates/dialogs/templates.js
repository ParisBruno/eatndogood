	...
	CKEDITOR.dialog.add( 'templates', function( editor ) {
		...
		function createTemplateItem( template, imagesPath ) {
			var item = CKEDITOR.dom.element.createFromHtml( '<a href="javascript:void(0)" tabIndex="-1" role="option" >' +
				'<div class="cke_tpl_item" style="margin: 5px; padding: 7px; border: #eeeeee 1px solid;"></div>' +
				'</a>' );
      ...
      if (html.includes('Image and Title')){
        html = '<table style="width:350px; margin: 0 !important;" class="cke_tpl_preview" role="presentation"><tbody><tr><td class="cke_tpl_preview_img"><img style="max-width: unset !important;" src="https://ckeditor.com/latest/plugins/templates/templates/images/template1.gif?t=M2G9" alt="" title=""></td><td style="white-space:normal; padding: 10px; vertical-align: middle !important;"><span class="cke_tpl_title">Image and Title</span><br><span>One main image with a title and text that surround the image.</span></td></tr></tbody></table>'
      } else if (html.includes('Strange Template')) {
        html = '<table style="width:350px; margin: 0 !important;" class="cke_tpl_preview" role="presentation"><tbody><tr><td class="cke_tpl_preview_img"><img style="max-width: unset !important;" src="https://ckeditor.com/latest/plugins/templates/templates/images/template2.gif?t=M2G9" alt="" title=""></td><td style="white-space:normal; padding: 10px; vertical-align: middle !important;"><span class="cke_tpl_title">Strange Template</span><br><span>A template that defines two columns, each one with a title, and some text.</span></td></tr></tbody></table>'
      } else if (html.includes('Text and Table')) {
        html = '<table style="width:350px; margin: 0 !important;" class="cke_tpl_preview" role="presentation"><tbody><tr><td class="cke_tpl_preview_img"><img style="max-width: unset !important;" src="https://ckeditor.com/latest/plugins/templates/templates/images/template3.gif?t=M2G9" alt="" title=""></td><td style="white-space:normal; padding: 10px; vertical-align: middle !important;"><span class="cke_tpl_title">Text and Table</span><br><span>A title with some text and a table.</span></td></tr></tbody></table>'
      }
