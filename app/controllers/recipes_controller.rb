class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      permitted = Recipe.globalize_attribute_names + [:food_image, :is_subscription, :enable_reservation,:enable_gift_card, :gift_card_image, :drink_image, :price, :inventory_count, :is_inventory_count, :subcategory_id, ingredient_ids: [], allergen_ids: [], style_ids: []]
